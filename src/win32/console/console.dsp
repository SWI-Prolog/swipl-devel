...
# ADD CPP /nologo /MD /W3 /Gm /GX /Zi /Od /I "..\xnt" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "__WIN32__" /YX /FD /ZI /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 msvcrtd.lib kernel32.lib user32.lib gdi32.lib advapi32.lib comdlg32.lib /nologo /base:"" /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"MSVCRT.LIB" /out:"..\..\..\bin/pltermD.dll"
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE=$(InputPath)
PostBuild_Cmds=if not exist ..\..\..\include mkdir  ..\..\..\include	copy\
