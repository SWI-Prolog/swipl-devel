...
int		scan_number(char **, int, Number);
...
Record		copyTermToHeap(term_t term);
void		copyTermToGlobal(term_t copy, Record term);
...
bool		vsysError(const char *fm, va_list args);
