...
# ADD LINK32 ..\lib\uxnt.lib user32.lib wsock32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\bin/libpl.dll"
...
# ADD LINK32 ..\lib\uxntD.lib user32.lib msvcrtd.lib wsock32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"msvcrt.lib" /out:"..\bin/libplD.dll"
...
# ADD LINK32 ..\lib\uxnt.lib user32.lib wsock32.lib /nologo /subsystem:windows /dll /machine:I386 /nodefaultlib:"libcmt.lib"
