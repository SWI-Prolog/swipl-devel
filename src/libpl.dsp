...
# ADD LINK32 ..\lib\uxnt.lib user32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\bin/libpl.dll"
...
# ADD LINK32 ..\lib\uxntD.lib user32.lib msvcrtd.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"msvcrt.lib" /out:"..\bin/libplD.dll"
# SUBTRACT LINK32 /pdb:none
...
# ADD LINK32 ..\lib\uxnt.lib user32.lib /nologo /subsystem:windows /dll /machine:I386 /nodefaultlib:"libcmt.lib"
