...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  { lTop = (LocalFrame)argFrameP(NFR, 2);
    PL_error("apply", 2, NULL, ERR_TYPE,
	     ATOM_callable, wordToTermRef(argFrameP(NFR, 0)));
    goto b_throw;
  }
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  { lTop = (LocalFrame)argFrameP(NFR, 2);
    PL_error("apply", 2, NULL, ERR_TYPE,
	     ATOM_list, wordToTermRef(argFrameP(NFR, 1)));
    goto b_throw;
  }
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
