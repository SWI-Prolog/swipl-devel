...
int errorcode;
{
    ...
    switch (errorcode) {
        ...
        case  nopp  : fprintf(stderr, "Missing post-post command\n");
                      break;
        case  bdpre : fprintf(stderr, "Preamble occurred inside a page\n");
                      break;
        case  bdbop : fprintf(stderr, "BOP-command occurred inside a page\n");
                      break;
        case  bdpst : fprintf(stderr, "Postamble occurred before end-of-page\n");
                      break;
        case  bdpp  : fprintf(stderr, "Postpost occurred before post-command\n");
                      break;
