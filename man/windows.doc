...
The SWI-Prolog Epilog console provided by \program{swipl-win.exe} has a
menu for accessing the most commonly used commands. We assume not all
menu entries need to be explained in detail. We make some exceptions:
