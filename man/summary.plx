...
\predicatesummary{abolish_nonincremental_tables}{0}{Abolish non-automatic tables}
\predicatesummary{abolish_nonincremental_tables}{1}{Abolish non-automatic tables}
...
\predicatesummary{atom_concat}{3}{Concatenate two atoms}
...
\predicatesummary{autoload_call}{1}{Call after autoloading}
...
\predicatesummary{call_cleanup}{2}{Guard a goal with a cleanup-handler}
...
\predicatesummary{debug_reset_from_class}{0}{Restore debug mode}
...
\predicatesummary{deterministic}{1}{Test determinicity of current clause}
...
\predicatesummary{epilog}{0}{Create a Prolog console}
\predicatesummary{epilog}{1}{Create a Prolog console}
...
\predicatesummary{expand_answer}{2}{Expand answer of query (deprecated)}
\predicatesummary{expand_answer}{3}{Expand answer of query}
...
\predicatesummary{message_action}{2}{\hook{prolog} Associate actions with messages}
...
\oppredsummary{mode}{1}{Define the mode for predicates}
...
\predicatesummary{prolog_exception_hook}{5}{Rewrite exceptions}
...
\predicatesummary{radial_restraint}{0}{Tabling radial restraint was violated}
...
\predicatesummary{read_string}{5}{Read string up to a delimiter}
...
\predicatesummary{set_epilog}{1}{Control the SWI-Prolog console}
...
\predicatesummary{write_size}{4}{Determine printed size for a term}
