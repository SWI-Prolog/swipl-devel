...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   ...
   which specialised predicate can be applied for Expr. The matching
   expression below was generated by:
...
X #\= Y :-
        (   var(X), integer(Y) ->
            ...
            do_queue
        ;   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % generated matcher code
           ((((((v_or_i(X), M1459=X), nonvar(Y)), Y=M1534+M1535), v_or_i(M1534)), M1464=M1534), v_or_i(M1535)), M1466=M1535->x_neq_y_plus_z(M1459, M1464, M1466); ((((((nonvar(X), X=M1616+M1617), v_or_i(M1616)), M1464=M1616), v_or_i(M1617)), M1466=M1617), v_or_i(Y)), M1459=Y->x_neq_y_plus_z(M1459, M1464, M1466); ((((((v_or_i(X), M1437=X), nonvar(Y)), Y=M1732-M1733), v_or_i(M1732)), M1442=M1732), v_or_i(M1733)), M1444=M1733->x_neq_y_plus_z(M1442, M1437, M1444); ((((((nonvar(X), X=M1814-M1815), v_or_i(M1814)), M1442=M1814), v_or_i(M1815)), M1444=M1815), v_or_i(Y)), M1437=Y->x_neq_y_plus_z(M1442, M1437, M1444); ((((((((integer(X), M1413=X), nonvar(Y)), Y=abs(M1930)), nonvar(M1930)), M1930=M1943-M1944), v_or_i(M1943)), M1420=M1943), v_or_i(M1944)), M1422=M1944->absdiff_neq_const(M1420, M1422, M1413); ((((((((nonvar(X), X=abs(M2031)), nonvar(M2031)), M2031=M2044-M2045), v_or_i(M2044)), M1420=M2044), v_or_i(M2045)), M1422=M2045), integer(Y)), M1413=Y->absdiff_neq_const(M1420, M1422, M1413)
