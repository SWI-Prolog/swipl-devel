...
\outerhsize=7in
%\outerhsize=16.5cm	% ANJO
%\outervsize=9.5in
% Alternative @smallbook page size is 9.25in
\outervsize=9.25in
%\outervsize=23.0cm	% ANJO
...
\def\doprintindex#1{%
  ...
  %deleted to get the arrows in the behaviour index (PCE)
  %\catcode`\$=\other
  \catcode`\_=\other
  \catcode`\~=\other
  %
...
\chapmacro {#1}{Chapter \the\chapno}%	Added `Chapter' (JW)
\gdef\thissection{#1}%
...
%		Modified for XPCE Reference Manual, Jan Wielemaker
\def\chfplain #1#2{%
  \pchapsepmacro
  {%
    \titlefont{\vbox{\hyphenpenalty=10000\tolerance=5000
                     \parindent=0pt\raggedright
		     \vskip 1.5in #2
		     \vskip \chapheadingskip #1}}%
  }%
  \bigskip
  \penalty5000
}
