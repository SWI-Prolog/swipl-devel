...
#ifdef REG_WIDE
                          , 0x02d0, 0x02d1, 0x02ee, 0x037a, 0x0386, 0x038c, 
...
static chr punctCharTable[] = {
    ...
    0x00ad, 0x00b7, 0x00bb, 0x00bf
#ifdef REG_WIDE
				  , 0x037e, 0x0387, 0x0589, 0x058a, 0x05be, 
...
static chr spaceCharTable[] = {
    0x0020, 0x00a0
#ifdef REG_WIDE
                  , 0x1680, 0x2028, 0x2029, 0x202f, 0x3000
#endif
};
...
static chr lowerCharTable[] = {
    0x00aa, 0x00b5, 0x00ba
#ifdef REG_WIDE
                          , 0x0101, 0x0103, 0x0105, 0x0107, 0x0109, 0x010b, 
...
static crange graphRangeTable[] = {
    {0x0021, 0x007e}, {0x00a0, 0x00ff}
#ifdef REG_WIDE
		    , {0x0100, 0x011f}, {0x0121, 0x021f}, {0x0222, 0x0233}, 
...
static int
strncmpAW(const char *a, const chr *w, size_t len)
