...
# PROP Output_Dir "..\..\lib"
# PROP Intermediate_Dir "..\objects\clib"
...
# ADD LINK32 ..\..\lib\libpl.lib kernel32.lib user32.lib wsock32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\..\bin\socket.dll"
# Begin Special Build Tool
SOURCE=$(InputPath)
PostBuild_Cmds=copy socket.pl ..\..\library	..\..\bin\plcon.exe -g make -t halt
...
# PROP Output_Dir "..\..\lib"
# PROP Intermediate_Dir "..\objects\clib\debug"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
...
# ADD LINK32 ..\lib\libplD.lib kernel32.lib user32.lib wsock32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\bin\socketD.dll" /pdbtype:sept
